...
enum PreferencesKeys {
    ...
    static let fiveHourRefreshAccountEnabled = "fiveHourRefreshAccountEnabled"
    static let fiveHourRefreshAccountTimes = "fiveHourRefreshAccountTimes"
    static let fiveHourRefreshModel = "fiveHourRefreshModel"
    static let fiveHourRefreshLastRuns = "fiveHourRefreshLastRuns"
    static let fiveHourRefreshWakeEnabled = "fiveHourRefreshWakeEnabled"
    static let fiveHourRefreshOwnsWakeSchedule = "fiveHourRefreshOwnsWakeSchedule"
